...
const Dashboard = () => {
  ...
  useEffect(() => {
    setSocket(io("https://yomessengerserver.onrender.com"));
  }, []);
  ...
  useEffect(() => {
    ...
    const fetchConversations = async () => {
      const res = await fetch(
        `https://yomessengerserver.onrender.com/api/conversations/${loggedInUser?.id}`,
        {
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      const res = await fetch(
        `https://yomessengerserver.onrender.com/api/users/${user?.id}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  const fetchMessages = async (conversationId, receiver) => {
    const res = await fetch(
      `https://yomessengerserver.onrender.com/api/message/${conversationId}?senderId=${user?.id}&&receiverId=${receiver?.receiverId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  const sendMessage = async (e) => {
    ...
    const res = await fetch(
      `https://yomessengerserver.onrender.com/api/message`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        ...
        <div className="mt-10 mx-14">
          ...
          <div>
            {conversations.length > 0 ? (
              ...
              <div className="mt-24 text-lg font-semibold text-center">
                No Conversations
              </div>
            )}
          </div>
